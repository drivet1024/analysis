...
SELECT
    ...
    SUM(pr.last_event >= l.max_event_time - INTERVAL 5 MINUTE) AS parcels_5m,
...
GROUP BY database_now, l.max_event_time, pr.customer_id, c.NAME, pr.conveyor_line
ORDER BY parcels_5m DESC, parcels_10m DESC, parcels_20m DESC, parcels_after_16 DESC;
