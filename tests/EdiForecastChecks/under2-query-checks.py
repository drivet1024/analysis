...
c.executescript('CREATE TABLE parcel_history(PARCEL_ID,WEIGHT,LENGTH,HEIGHT,WIDTH,DATE_INSERT,CUSTOMER_ID,DATE_LIV,DEPOT_ID,EXCEPTION,SOURCE_TYPE,SOURCE_ID,VOID); CREATE TABLE parcel(PARCEL_ID,CUSTOMER_ID); CREATE TABLE customer(CUSTOMER_ID,NAME); INSERT INTO customer VALUES(1,"Client A"),(2,"Client B"); INSERT INTO parcel VALUES(3,2);')
for pid,client,weight,l,h,w,time in [(1,1,1,10,2,4,'16:00'),(1,1,1.5,20,4,8,'17:00'),(1,1,2.5,0,0,0,'18:00'),(2,1,1,None,None,None,'17:00'),(3,None,1,10,2,4,'17:00'),(4,1,3,100,100,100,'17:00'),(5,None,1,2,3,4,'17:00')]:
    t='2026-09-17 '+time
    c.execute('INSERT INTO parcel_history VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)',(pid,weight,l,h,w,t,client,t,1,903,200,None,0))
